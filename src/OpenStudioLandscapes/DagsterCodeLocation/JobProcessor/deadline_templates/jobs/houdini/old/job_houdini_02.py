...
from OpenStudioLandscapes.DagsterCodeLocation.JobProcessor.deadline_templates.plugins.houdini.plugin_houdini__19_5_805 import plugin

job["job_file"] = TEST_FIXTURES / "houdini" / "project" / "vivi_025.hip"
